...
<body class="font-[poppins] bg-emerald-600">
    <div class="container">
        <div class="profile-card mx-auto" style="max-width: 600px;">
            ...
            <div class="card-body ">
                <div class="mb-3">
                    <label class="form-label text-right font-semibold">Nama</label>
                    <input type="text" class="form-control-plaintext" readonly value="<?php echo isset($_SESSION['nama']) ? htmlspecialchars($_SESSION['pelanggan']) : 'Pelanggan tidak tersedia'; ?>">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <label class="form-label text-right font-semibold">Alamat</label>
                ...
                <a href="home.php" class="btn bg-zinc-600 text-white hover:bg-zinc-700">Back to Home</a>
