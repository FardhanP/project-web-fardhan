...
if(isset($id)){
    ...
    if(isset($_GET['aksi'])){
        if($_GET['aksi'] == 'hapus'){
            ...
            $query = mysqli_query($koneksi, "INSERT INTO tb_transaksi(tanggal,id_pelanggan,total) VALUES ('". date("Y-m-d") . "','$id','$total')");
...
<body class="bg-emerald-600 font-[poppins]">
    ...
    <main class="container mx-auto my-8 p-4 shadow-lg rounded-lg">
            ...
            <?php
                ...
                <div class="min-w-full bg-slate-50 flex items-center gap-4 p-4 justify-between">
                    <div class="flex items-center gap-4">
                        <img src="image/<?php echo $value['foto']?>" alt="" class="w-32">
        ...
        <div class="mt-8">
            <form action="" method="POST">
                <a href="home.php" class="btn bg-zinc-700 hover:bg-zinc-800 text-white btn-sm ">Lanjut belanja</a>
